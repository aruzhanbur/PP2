...
background = pygame.image.load("/Users/aruzhanb/Documents/PP2/lab8/AnimatedStreet.png")

#classes for characters 
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("/Users/aruzhanb/Documents/PP2/lab8//Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/aruzhanb/Documents/PP2/lab8//coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, w - 40), 0)
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("/Users/aruzhanb/Documents/PP2/lab8//Player.png")
        self.rect = self.image.get_rect()
...
# Define the value of N coins needed to increase enemy speed
N = 10  
...
while True:
    ...
    if scorecoin >= N:
        speed += 1  # Increase the enemy speed
        N += 10     # Increase the threshold for the next speed increase

    # To be run if collision occurs between Player and Enemy
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('/Users/aruzhanb/Documents/PP2/lab8//crash.wav').play()
          time.sleep(0.5)
    ...
    for coin in coin_collisions:
        scorecoin += random.randint(1, 5)
        pygame.display.update()

    # Ensure there is always at least 1 coin on the screen
    if len(coins) < 1:
        new_coin = Coin()
        coins.add(new_coin)
